...
In the above example, if an app already exists in the user directory and user chooses to 'Continue Move' then the function would proceed with default behavior: the existing app will be trashed and the active app moved into its place.
